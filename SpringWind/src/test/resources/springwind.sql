...
-- ----------------------------
BEGIN;
INSERT INTO `permission` VALUES ('2', '0', '权限管理', '0', '0', '2', '/perm/', '2000', 'fa fa-eye', '权限管理'), ('1', '0', '功能管理', '0', '0', '1', '/sys/', '1000', 'fa fa-magic', '功能管理'), ('3', '0', '系统监控', '0', '0', '3', '/monitor/', '3000', 'fa fa-bar-chart-o', '系统监控'), ('4', '0', '操作日志', '0', '0', '4', '/log/', '4000', 'fa fa-bug', '操作日志'), ('11', '1', '发送邮件测试', '0', '0', '1', '/sys/mail/send.html', '1001', null, '发送邮件测试'), ('12', '1', '暂无2', '0', '0', '2', 'none2.html', '1002', null, '暂无2'), ('21', '2', '用户管理', '0', '0', '1', '/perm/user/list.html', '2001', null, '用户管理'), ('22', '2', '角色管理', '0', '0', '2', '/perm/role/list.html', '2002', null, '角色管理'), ('23', '2', '权限管理', '0', '0', '3', '/perm/permission/list.html', '2003', null, '权限管理'), ('31', '3', '警告列表', '0', '0', '1', 'abc.html', '3001', null, '警告列表'), ('32', '3', '实时监控', '0', '0', '2', '/monitor/realTime.html', '3002', null, '实时监控'), ('41', '4', '日志列表', '0', '0', '1', 'sad.htm', '4001', null, '日志列表');
COMMIT;
